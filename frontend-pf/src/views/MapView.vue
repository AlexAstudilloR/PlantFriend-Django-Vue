...
onMounted(() => {
  ...
  L.marker([-2.13396, -79.59337], { icon: milagroIcon })
    .addTo(map.value)
  ...
  L.marker([-2.1310410852055983, -79.91311289283892], { icon: viveroPlantilandia })
    .addTo(map.value)
    .bindPopup('<b>Vivero Plantilandia</b>')
  const viveroJhonatan = L.AwesomeMarkers.icon({
    icon: 'seedling',
    markerColor: 'green',
    prefix: 'fa'
  })
  L.marker([-2.1447483028039347, -79.57438558896074], { icon: viveroJhonatan })
    .addTo(map.value)
    .bindPopup('<b>Vivero Jhonatan</b>')
  const viveroElsol = L.AwesomeMarkers.icon({
    icon: 'seedling',
    markerColor: 'green',
    prefix: 'fa'
  })
  L.marker([-2.137391052888829, -79.59651124533325], { icon: viveroElsol })
    .addTo(map.value)
